...
RUN mkdir /Site && cd /Site && git clone https://github.com/FOSSEE/scilab_for_xcos_on_cloud.git && cd scilab_for_xcos_on_cloud && apt-get build-dep scilab -y && ./configure --disable-static-system-lib && make -j4
